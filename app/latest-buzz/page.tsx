...
import { Calendar, Eye, Tag, User, TrendingUp } from 'lucide-react';
...
export default function LatestBuzzPage() {
  const [posts, setPosts] = useState<Post[]>([]);
  const [search, setSearch] = useState('');

  useEffect(() => {
    // Load recent published posts from admin dashboard (last 10)
    ...
    <div className="min-h-screen bg-gray-50">
      ...
      <div className="bg-gradient-to-r from-purple-600 to-pink-600 text-white py-20 pt-32">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          >
            ...
            <h1 className="text-4xl md:text-5xl font-bold">Latest Buzz</h1>
          </motion.div>
          <motion.p
            initial={{ opacity: 0, y: -20 }}
            animate={{ opacity: 1, y: 0 }}
          ...
          >
            What's trending at our college right now
          </motion.p>
        </div>
      </div>
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        <input
          ...
          placeholder="Search buzz by heading or description..."
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pb-16">
        {filteredPosts.length === 0 ? (
          <div className="text-center py-20">
            ...
            <h3 className="text-xl font-semibold text-gray-900 mb-2">No buzz found</h3>
            <p className="text-gray-600">
              {search ? 'Try adjusting your search' : 'Check back soon for the latest buzz!'}
            </p>
          </div>
        ) : (
          <motion.div
