...
import { getPosts, savePosts, getCategories, updateCategoryPostCounts, getMedia, saveMedia } from '@/app/admin/utils/storage';
...
export default function PostsPage() {
  ...
  const handleThumbnailFileChange = async (e: React.ChangeEvent<HTMLInputElement>) => {
    ...
    try {
      setIsUploading(true);
      // Read file as data URL for local storage persistence
                    ...
                    >
                      <td className="px-6 py-4">
                        <div className="flex items-center gap-3">
                          <div className="w-12 h-12 bg-gradient-to-br from-blue-500 to-purple-600 rounded-lg flex-shrink-0 overflow-hidden">
                      ...
                      <td className="px-6 py-4">
                        <span className="px-2 py-1 bg-blue-50 dark:bg-blue-900/20 text-blue-600 dark:text-blue-400 text-xs rounded-full">
                          {post.category}
                        </span>
                      </td>
